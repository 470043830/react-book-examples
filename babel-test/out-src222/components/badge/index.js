...
export default class WgBadge extends WgComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Block, null, dot ? /*#__PURE__*/React.createElement(View, {
      className: classNames(dotClass, this.props.className),
      style: customStyle
    }) : val !== '' && /*#__PURE__*/React.createElement(View, {
      className: classNames(numClass, this.props.className),
      style: customStyle
    }, val)); // return (
