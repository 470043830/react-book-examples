...
export default class WgButton extends WgComponent {
  ...
  render() {
    ...
    if (loading) {
      loadingComponent = /*#__PURE__*/React.createElement(View, {
        className: "wg-button__icon"
    ...
    const webButton = /*#__PURE__*/React.createElement(Button, {
    ...
    }, isWEB && !disabled && webButton, isWEAPP && !disabled && button, loadingComponent, /*#__PURE__*/React.createElement(View, {
      className: "wg-button__text"
    }, this.props.children));
  }
