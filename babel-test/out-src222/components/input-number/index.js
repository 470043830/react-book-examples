...
import WgComponent from '../../common/component'; // TODO: Check all types
// 实现两数相加并保留小数点后最短尾数
...
export default class WgInputNumber extends WgComponent {
  constructor() {
    ...
    this.handleValue = value => {
      ...
      let resultValue = value === '' ? min : value; // 此处不能使用 Math.max，会是字符串变数字，并丢失 .
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(View, {
      ...
      className: "wg-icon wg-icon-subtract wg-input-number__btn-subtract"
    })), /*#__PURE__*/React.createElement(Input, {
      className: "wg-input-number__input",
      style: inputStyle,
      type: type,
      ...
      className: "wg-icon wg-icon-add wg-input-number__btn-add"
    })));
  }
