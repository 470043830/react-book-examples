...
export default class WgSearchBar extends React.PureComponent {
  constructor(props) {
    ...
    this.search = (e = {
      ...
      if (e.type === 'input') {
        ...
        // });
        this._inputValue = e.detail.value; // console.log('this._inputValue, ', this._inputValue);
        ...
        this.props.onSearchData({
          ...
          imgUrl: this.state.upSeacrchImgUrl || ''
        });
      }
  ...
  render() {
    ...
    let iconDom = /*#__PURE__*/React.createElement(View, {
      className: "wg-align-items"
    }, upSeacrchImgUrl && /*#__PURE__*/React.createElement(Image, {
      className: "wg-up-img",
      src: upSeacrchImgUrl
    }), isSearchImg && !upSeacrchImgUrl && /*#__PURE__*/React.createElement(Image, {
      className: "wg-up-img ",
      src: upImgUrl,
      onClick: this.upImg.bind(this)
    }), (value || upSeacrchImgUrl) && /*#__PURE__*/React.createElement(Image, {
      className: "wg-close-icon wg-ml-20",
      onClick: this.clearData,
      src: close
    }));
    /**文本值存在或者用户进行图片搜索， 隐藏右侧icon 显示搜索btn */

    let rightDom = value ? /*#__PURE__*/React.createElement(View, {
      className: "wg-search-btn wg-ft-28 wg-ml-24",
      onClick: this.search
    }, "\u641C\u7D22") : /*#__PURE__*/React.createElement(View, {
      className: "wg-search-right wg-justify-content-flex-start"
    }, isTemplate && /*#__PURE__*/React.createElement(Image, {
      src: tempIconUrl,
      className: "wg-ml-32 wg-mr-24 wg-right-icon",
      onClick: this.queryDom.bind(this)
    }), isTemplate && isFilterData && /*#__PURE__*/React.createElement(View, {
      className: "wg-line"
    }), isFilterData && /*#__PURE__*/React.createElement(Image, {
      src: filterImg,
      className: "wg-ml-24 wg-right-icon",
      onClick: onFilterData
    }));
    return /*#__PURE__*/React.createElement(View, {
      className: "wg-search-input-box wg-p32"
    }, /*#__PURE__*/React.createElement(View, {
      className: "wg-search-left wg-space-between "
    }, /*#__PURE__*/React.createElement(View, {
      className: "wg-search-input wg-justify-content-flex-start"
    }, /*#__PURE__*/React.createElement(Image, {
      className: "wg-search-img",
      src: searchImgUrl,
      onClick: this.search
    }), /*#__PURE__*/React.createElement(Input, {
      className: "wg-ft-28 wg-ml-8 wg-input wg-mr-20",
      placeholder: "\u641C\u7D22",
      value: this._inputValue,
      onInput: this.search,
      onConfirm: this.search
    })), iconDom), rightDom, /*#__PURE__*/React.createElement(View, {
      style: mask,
      className: "wg-mask-box",
      onClick: this.hideMask.bind(this),
      onTouchMove: this.touchMove.bind(this)
    }, /*#__PURE__*/React.createElement(View, {
      className: classNames('wg-template', isTempState ? 'wg-template-height' : '')
    }, /*#__PURE__*/React.createElement(ComponentTemplate, {
      onQueryData: onQueryTemplateData,
      onQueryImgUrl: this.onQueryImgUrl.bind(this),
      templateList: templateList
    }))), isTempState && /*#__PURE__*/React.createElement(View, {
      className: "wg-top-mask",
      style: maskTop,
      onClick: this.hideMask.bind(this),
      onTouchMove: this.touchMove.bind(this)
    }));
